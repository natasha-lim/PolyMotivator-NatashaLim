...
const ImageGenerator = {
    ...
    API_KEY: 'AIzaSyBt0kKafhU07ivBJxsCmun-2O4Plgvcaig',
...
Make it inspirational and actionable, suitable for a polytechnic student planning their future.`;
    ...
    async callGeminiAPI(prompt) {
        const API_URL = `https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash-image:generateContent?key=AIzaSyBt0kKafhU07ivBJxsCmun-2O4Plgvcaig&callback=initMap`;
